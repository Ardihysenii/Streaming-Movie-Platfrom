                  ...
                  <div className="player-subtitle-menu" role="dialog" aria-label="Subtitle settings">
                    ...
                    {subtitleCustomizeOpen ? (
                      <div className="player-subtitle-customize">
                        ...
                        <label>Sync <span>{subtitleOffset > 0 ? "+" : ""}{subtitleOffset.toFixed(1)}s</span><input type="range" min="-15" max="15" step="0.5" value={subtitleOffset} style={{ "--range-progress": `${((subtitleOffset + 15) / 30) * 100}%` }} onChange={(event) => setSubtitleOffset(Number(event.target.value))} /></label>
                      </div>
                    ) : null}
