...
export const CaptionsIcon = (props: IconProps) => (
  <IconBase {...props}>
    <path d="M5 4.5h14A2.5 2.5 0 0 1 21.5 7v7A2.5 2.5 0 0 1 19 16.5h-8.5L7 20v-3.5H5A2.5 2.5 0 0 1 2.5 14V7A2.5 2.5 0 0 1 5 4.5Z" />
    <path d="M9.5 10.5a2 2 0 1 0 0 3M16 10.5a2 2 0 1 0 0 3" />
  </IconBase>
);
