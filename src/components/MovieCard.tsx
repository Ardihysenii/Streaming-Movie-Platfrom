      ...
      <div className="movie-card-body">
        <Link href={href} aria-label={"View " + movie.title} className="poster-link">
          ...
          <span className={"poster-image" + (loaded ? " is-loaded" : "")}>
            <Image src={imageUrl(movie.poster_path ?? movie.backdrop_path, "w500")} alt={movie.title + " artwork"} fill sizes="(max-width: 600px) 42vw, (max-width: 1100px) 25vw, 220px" priority={priority} onLoad={() => setLoaded(true)} />
          </span>
